...
- After merging `axiom-qwen38-q6-switcher`, switch Axiom from refreshed `origin/master`. Confirm Q6 is the default active link, the 128K MTP model remains fully GPU-resident with safe headroom, API/OpenCode checks pass, and `qwen-model` lifecycle plus Q6-Q4-Q6 switching work without concurrent model residency.
